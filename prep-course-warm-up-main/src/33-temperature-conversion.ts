...
const fahrenheitToCelsius = (temperature: number) => {return Math.round((temperature - 32) * 0.5556 *10)/10};
const celsiusToFahrenheit = (temperature:number) => {return Math.round(temperature *(9/5) + 32 *10)/10};
